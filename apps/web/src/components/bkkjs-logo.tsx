export function BkkjsLogo({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 759 238"
      ...
      className={className}
    >
      <g transform="matrix(0.732625,0,0,0.419753,139.199,-18.4691)">
        <clipPath id="_clip1">
          <rect x="-190" y="44" width="1036" height="567"></rect>
        </clipPath>
        <g clipPath="url(#_clip1)">
          <g transform="matrix(0.516803,0,0,0.902014,683.581,327.093)">
          ...
          <g transform="matrix(2.20987,0,0,3.85705,-425.635,-905.102)">
            <g transform="matrix(152.979,0,0,152.979,95.6586,392.214)">
              <path
